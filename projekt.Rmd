...
```{r graf.BDP, echo=FALSE, message=FALSE, fig.align='center', fig.cap='Graf BDP'}
    graf.BDP
```
...
```{r graf.BDP2016, echo=FALSE, message=FALSE, fig.align='center', fig.cap='Graf BDP 2016'}
    graf.BDP2016
```

```{r graf.delezBDP, echo=FALSE, message=FALSE, fig.align='center', fig.cap='Graf delez BDP'}
    graf.delezBDP
```
...
```{r graf.rastBDP, echo=FALSE, message=FALSE, fig.align='center', fig.cap='Graf rast BDP'}
    graf.rastBDP
```
...
graf.rastBDP_Nem
```{r graf.rastBDP_Nem, echo=FALSE, message=FALSE, fig.align='center', fig.cap='Graf rast BDP Nem'}
    graf.rastBDP_Nem
```
...
```{r graf.inflacija, echo=FALSE, message=FALSE, fig.align='center', fig.cap='Graf inflacija'}
    graf.inflacija
```
...
```{r graf.inflacijaEU, echo=FALSE, message=FALSE, fig.align='center', fig.cap='Graf Inflacija EU'}
    graf.inflacijaEU
```
...
graf.obrestne
```{r graf.obrestne, echo=FALSE, message=FALSE, fig.align='center', fig.cap='Graf obrestne'}
    graf.obrestne
```
