...
Za svoj projekt sem si izbral makroekonomsko analizo evropskega gospodarstva. Ta tematika me je privabila zaradi tesne povezave s predmetom makroekonomija in zaradi mojega splošnega zanimanja za gibanje evropskega in svetovnega gospodarstva, s katerim bom imel v prihodnosti po vsej verjetnosti veliko opravka.
...
```
Podatke sem uvozil iz strani evrostat, ter iz uradne strani ECB v obliki CSV in HTML.
